...
aluno1 = Aluno(1, 'Felipe', 19, 'masculino', 64.3, 1.85)
aluno2 = Aluno(2, 'Rodrigo', 35, 'masculino', 78.3, 1.91)
professor = Professor('123456-P/PI', 'Raimundo', 55, 'masculino', 'musculacao')
gestor = Gestor(123, 'Fernanda', 61, 'feminino', 'executivo')
...
treino1 = Treino('Treino de braços')
treino2 = Treino('Treino de perna')
...
print(aluno1.to_dict())
print(professor.to_dict())
professor.adicionar_aluno(aluno2)
print(professor.to_dict())
print(gestor.to_dict())'''
